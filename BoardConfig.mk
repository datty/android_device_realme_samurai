...
#Added to fix new naming
SOONG_CONFIG_surfaceflinger += udfps_lib
SOONG_CONFIG_surfaceflinger_udfps_lib := libudfps_extension.samurai
#Added by suggestion for zlayer issues
SOONG_CONFIG_surfaceflinger_udfps_dim_layer := false
TARGET_HAS_OPTICAL_FOD := true
TARGET_USES_FOD_BRIGHTNESS := true
...
SOONG_CONFIG_libinit_vendor_init_lib := libinit_samurai
...
# Added - wouldn't build without META/ab_partitions.txt
